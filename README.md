...
Download archive.zip from https://www.kaggle.com/datasets/philosopher0808/gym-workoutexercises-video. Yes, its a lot -- 10 GB. I'll make another file that removes selected files 
from the dataset in a bit.
